...
class Timesheet extends Model 
{
    ...
    protected $fillable = [
        'employee_id', 'week_starting', 'status', 'submitted_at', 'approved_at', 'approved_by', 'notes'
    ];
    ...
    {
        return $this->hasMany(\App\Modules\Hr\Models\TimesheetEntry::class, 'timesheet_id', 'id');
    }
    ...
    {
        return \App\Modules\Hr\Database\Factories\TimesheetFactory::new();
    }
}