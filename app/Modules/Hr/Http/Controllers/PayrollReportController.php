...
public function __construct(
    ...
    public function show(PayrollRun $payrollRun)
    {
        ...
        return view('hr.views::components.livewire.bootstrap.payroll.reports.run-report', [
            'reportData' => $data,
    ...
    {
        $data = $this->reportService->generateReportData($payrollRun);
        $pdf = PDF::loadView('hr.views::components.livewire.bootstrap.payroll.reports.run-report-pdf', $data);
