<x-core.views::layouts.app>
  ...
  <x-core.views::tab-bar>
    <x-hr.views::layouts.navbars.auth.allowances-and-bonuses-tab-bar-links active='role-bonuses' />
</x-core.views::tab-bar>


    <livewire:data-tables.data-table-manager model="App\Modules\hr\Models\RoleBonus"
