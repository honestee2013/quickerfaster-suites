...
<x-core.views::layouts.app>
    ...
    <x-core.views::tab-bar>
        <x-production.views::layouts.navbars.auth.production-order-tab-bar-links active='items'  />
    </x-core.views::tab-bar>

    <livewire:core.data-tables.data-table-manager model="App\\Modules\\Production\\Models\\ProductionOrderItem"
        pageTitle="Production Order Requested Products"
        queryFilters=[]
        :hiddenFields="[
            'onTable' => [],
        ]"
