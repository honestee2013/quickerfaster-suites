...
<x-core.views::layouts.app>
    ...
    <x-core.views::tab-bar>
        <x-production.views::layouts.navbars.auth.production-logs-tab-bar-links active='production-log-downtimes'  />
    </x-core.views::tab-bar>

    <livewire:core.data-tables.data-table-manager model="App\\Modules\\Production\\Models\\ProductionProcessDowntime"
        pageTitle="Manage Production Log Downtimes"
        queryFilters=[]
        :hiddenFields="[
            'onTable' => [],
        ]"
