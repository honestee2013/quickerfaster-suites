...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "User Salary Record"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.user-salary-record-tab-bar-links','data' => ['active' => 'user-salaries']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.user-salary-record-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-salaries']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391)): ?>
<?php $attributes = $__attributesOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391; ?>
<?php unset($__attributesOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391)): ?>
<?php $component = $__componentOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391; ?>
<?php unset($__componentOriginaled89bcd4e4d5afd4c5e0fe7cd10e4391); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\UserSalary','pageTitle' => 'User Salaries Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2553930328-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/user-salaries.blade.php ENDPATH**/ ?>