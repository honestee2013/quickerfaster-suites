                        ...
                        <div class="form-group">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($type === 'textarea'): ?>
                                <textarea wire:model.<?php echo e($reactivity); ?>="fields.<?php echo e($field); ?>" id="<?php echo e($field); ?>" class="form-control"
                                    name = "<?php echo e($field); ?>" value= "<?php echo e($field); ?>" rows="3"><?php echo e($fields[$field] ?? ''); ?></textarea>
                            ...
                            <?php elseif($type === 'select'): ?>
                                ...
                                <?php else: ?>
                                        <select wire:key="select-<?php echo e($field); ?>" wire:model.<?php echo e($reactivity); ?>="fields.<?php echo e($field); ?>" name = "<?php echo e($field); ?>"
                                            value= "<?php echo e($field); ?>" id="<?php echo e($field); ?>" class="form-control" placeholder="">
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-2 rounded border border-red p-1 ms-3 image-container" id="image-container-<?php echo e($field); ?>">
                                        ...
                                        <?php if(isset($fields[$field])): ?>
                                            ...
                                            <img id="image-preview-<?php echo e($field); ?>" 
                                                <?php if(is_object($fields[$field]) && $fields[$field]->temporaryUrl()): ?> src="<?php echo e($fields[$field]->temporaryUrl()); ?>"

                                                                        
                                                                        <?php elseif(isset($fields[$field])): ?>
                                                                            src="<?php echo e(asset('storage/' . $fields[$field])); ?>" <?php endif; ?>
                                                alt="Image Preview" style="width: 100%;" />

                                            <!------ Crop Icon-------->
                                            <span
                                                <?php if(is_object($fields[$field]) && $fields[$field]->temporaryUrl()): ?> onclick="Livewire.dispatch('openCropImageModalEvent', ['<?php echo e($field); ?>', '<?php echo e($fields[$field]->temporaryUrl()); ?>', '<?php echo e($this->getId()); ?>'])"
                                                                        <?php else: ?>
                                                                            onclick="Livewire.dispatch('openCropImageModalEvent', ['<?php echo e($field); ?>', '<?php echo e(asset('storage/' . $fields[$field])); ?>', '<?php echo e($this->getId()); ?>'])" <?php endif; ?>
                            ...
                            <?php elseif(str_contains($type, "date")): ?>
                                ...
                                <input type="<?php echo e($type); ?>" wire:model.<?php echo e($reactivity); ?>="fields.<?php echo e($field); ?>" id="<?php echo e($field); ?>"
                                    class="form-control rounded-pill <?php echo e((str_contains($type, "time")? 'datetimepicker': 'datepicker')); ?>" value="<?php echo e($fields[$field] ?? ''); ?>" name="<?php echo e($field); ?>"
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package2/app/Modules/Core/Resources/views/data-tables/data-table-form.blade.php ENDPATH**/ ?>