...
<?php $component->withAttributes(['moduleName' => 'hr']); ?>
        <?php if (isset($component)) { $__componentOriginal60e1bf294ca02346ef8cc8f2cd340793 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60e1bf294ca02346ef8cc8f2cd340793 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.sidebar-links','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.sidebar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal60e1bf294ca02346ef8cc8f2cd340793)): ?>
<?php $attributes = $__attributesOriginal60e1bf294ca02346ef8cc8f2cd340793; ?>
<?php unset($__attributesOriginal60e1bf294ca02346ef8cc8f2cd340793); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal60e1bf294ca02346ef8cc8f2cd340793)): ?>
<?php $component = $__componentOriginal60e1bf294ca02346ef8cc8f2cd340793; ?>
<?php unset($__componentOriginal60e1bf294ca02346ef8cc8f2cd340793); ?>
<?php endif; ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Performance Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal566a149365b3d0eca55cf7e0c797cfd3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal566a149365b3d0eca55cf7e0c797cfd3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.performance-management-tab-bar-links','data' => ['active' => 'user-reviews']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.performance-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-reviews']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal566a149365b3d0eca55cf7e0c797cfd3)): ?>
<?php $attributes = $__attributesOriginal566a149365b3d0eca55cf7e0c797cfd3; ?>
<?php unset($__attributesOriginal566a149365b3d0eca55cf7e0c797cfd3); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal566a149365b3d0eca55cf7e0c797cfd3)): ?>
<?php $component = $__componentOriginal566a149365b3d0eca55cf7e0c797cfd3; ?>
<?php unset($__componentOriginal566a149365b3d0eca55cf7e0c797cfd3); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\UserReview','pageTitle' => 'User Reviews','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-468293060-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/user-reviews.blade.php ENDPATH**/ ?>