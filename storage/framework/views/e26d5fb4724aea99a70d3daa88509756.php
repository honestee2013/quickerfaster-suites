...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "User Status Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginale39eaf123f1bcf8166c468cc6dd1c348 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale39eaf123f1bcf8166c468cc6dd1c348 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'user.views::components.layouts.navbars.auth.user-status-management-tab-bar-links','data' => ['active' => 'user-status-categories']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('user.views::layouts.navbars.auth.user-status-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-status-categories']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale39eaf123f1bcf8166c468cc6dd1c348)): ?>
<?php $attributes = $__attributesOriginale39eaf123f1bcf8166c468cc6dd1c348; ?>
<?php unset($__attributesOriginale39eaf123f1bcf8166c468cc6dd1c348); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale39eaf123f1bcf8166c468cc6dd1c348)): ?>
<?php $component = $__componentOriginale39eaf123f1bcf8166c468cc6dd1c348; ?>
<?php unset($__componentOriginale39eaf123f1bcf8166c468cc6dd1c348); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\user\Models\UserStatusCategory','pageTitle' => 'Status Categories Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1743397238-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/User/Resources/views/user-status-categories.blade.php ENDPATH**/ ?>