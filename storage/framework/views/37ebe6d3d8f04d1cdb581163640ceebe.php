...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'core.views::components.layouts.navbars.sidebar-link-item','data' => ['iconClasses' => 'fas fa-business-time','url' => 'hr/role-schedules','title' => 'Role Schedules','anchorClasses' => ''.e(($active == 'role-schedules')? 'active': '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['iconClasses' => 'fas fa-business-time','url' => 'hr/role-schedules','title' => 'Role Schedules','anchorClasses' => ''.e(($active == 'role-schedules')? 'active': '').'']); ?>
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/components/layouts/navbars/auth/schedule-management-tab-bar-links.blade.php ENDPATH**/ ?>