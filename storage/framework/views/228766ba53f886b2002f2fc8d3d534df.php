...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'user.views::components.layouts.navbars.auth.users-management-tab-bar-links','data' => ['active' => 'basic-info']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'basic-info']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-702546329-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/User/Resources/views/basic-info.blade.php ENDPATH**/ ?>