...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.performance-management-tab-bar-links','data' => ['active' => 'performance-reviews']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'performance-reviews']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\PerformanceReview','pageTitle' => 'Performance Reviews Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-800596180-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/performance-reviews.blade.php ENDPATH**/ ?>