...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'core.views::components.layouts.navbars.auth.sidebar','data' => ['moduleName' => 'core']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['moduleName' => 'core']); ?>
            <?php if (isset($component)) { $__componentOriginal6006db106c8a8414146fd4487d7ba1ec = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6006db106c8a8414146fd4487d7ba1ec = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'core.views::components.layouts.navbars.auth.sidebar-links','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('core.views::layouts.navbars.auth.sidebar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal6006db106c8a8414146fd4487d7ba1ec)): ?>
<?php $attributes = $__attributesOriginal6006db106c8a8414146fd4487d7ba1ec; ?>
<?php unset($__attributesOriginal6006db106c8a8414146fd4487d7ba1ec); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6006db106c8a8414146fd4487d7ba1ec)): ?>
<?php $component = $__componentOriginal6006db106c8a8414146fd4487d7ba1ec; ?>
<?php unset($__componentOriginal6006db106c8a8414146fd4487d7ba1ec); ?>
<?php endif; ?>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\\Modules\\Core\\Models\\Status']);

$__html = app('livewire')->mount($__name, $__params, 'lw-4084766394-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Core/Resources/views/user-profile.blade.php ENDPATH**/ ?>