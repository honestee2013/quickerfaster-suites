...
<?php endif; ?>
     ...
     <?php $__env->slot('pageHeader', null, []); ?> 
        <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [
            'pageTitile' => 'Payment Structure',
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\RoleSalary','pageTitle' => 'Role Salaries Overview','queryFilters' => [],'hiddenFields' => [
            'onTable' => [],
            'onNewForm' => [],
            'onEditForm' => [],
            'onQuery' => [],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1062457397-0', $__slots ?? [], get_defined_vars());
