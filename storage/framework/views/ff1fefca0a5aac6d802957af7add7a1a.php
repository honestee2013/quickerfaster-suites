...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'user.views::components.layouts.navbars.auth.user-profile-management-tab-bar-links','data' => ['active' => 'customer-profile']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'customer-profile']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\User\Models\CustomerProfile','pageTitle' => 'Customer Profile Management','queryFilters' => [

        ],'hiddenFields' => [
            'onTable' => [],
        ]]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2159096603-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/User/Resources/views/customer-profile-management.blade.php ENDPATH**/ ?>