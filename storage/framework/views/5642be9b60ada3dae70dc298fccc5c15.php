...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Bonuses & Deductions"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal72890e319f7b230a445478adec6ff34c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal72890e319f7b230a445478adec6ff34c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.bonuses-and-deductions-tab-bar-links','data' => ['active' => 'user-deductions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.bonuses-and-deductions-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-deductions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal72890e319f7b230a445478adec6ff34c)): ?>
<?php $attributes = $__attributesOriginal72890e319f7b230a445478adec6ff34c; ?>
<?php unset($__attributesOriginal72890e319f7b230a445478adec6ff34c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal72890e319f7b230a445478adec6ff34c)): ?>
<?php $component = $__componentOriginal72890e319f7b230a445478adec6ff34c; ?>
<?php unset($__componentOriginal72890e319f7b230a445478adec6ff34c); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\UserDeduction','pageTitle' => 'User Deductions','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2363022571-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/user-deductions.blade.php ENDPATH**/ ?>