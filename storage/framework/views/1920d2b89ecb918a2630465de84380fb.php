...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'user.views::components.layouts.navbars.auth.users-management-tab-bar-links','data' => ['active' => 'users']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\user\Models\User','pageTitle' => 'User Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
    0 => 'password',
...
$__html = app('livewire')->mount($__name, $__params, 'lw-303484423-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/User/Resources/views/users.blade.php ENDPATH**/ ?>