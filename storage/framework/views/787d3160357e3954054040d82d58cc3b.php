...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Time Off Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalbac8d506bd13f591dc355040e4e21335 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbac8d506bd13f591dc355040e4e21335 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.time-off-management-tab-bar-links','data' => ['active' => 'time-off-requests']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.time-off-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'time-off-requests']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbac8d506bd13f591dc355040e4e21335)): ?>
<?php $attributes = $__attributesOriginalbac8d506bd13f591dc355040e4e21335; ?>
<?php unset($__attributesOriginalbac8d506bd13f591dc355040e4e21335); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbac8d506bd13f591dc355040e4e21335)): ?>
<?php $component = $__componentOriginalbac8d506bd13f591dc355040e4e21335; ?>
<?php unset($__componentOriginalbac8d506bd13f591dc355040e4e21335); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\TimeOffRequest','pageTitle' => 'Time Off Requests Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-592804304-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/time-off-requests.blade.php ENDPATH**/ ?>