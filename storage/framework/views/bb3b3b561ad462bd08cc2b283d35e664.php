...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Payroll Components"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal1c54acf2bb0d54c9e6cd761177fcd545 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1c54acf2bb0d54c9e6cd761177fcd545 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.payroll-components-tab-bar-links','data' => ['active' => 'deduction-types']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.payroll-components-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'deduction-types']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1c54acf2bb0d54c9e6cd761177fcd545)): ?>
<?php $attributes = $__attributesOriginal1c54acf2bb0d54c9e6cd761177fcd545; ?>
<?php unset($__attributesOriginal1c54acf2bb0d54c9e6cd761177fcd545); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1c54acf2bb0d54c9e6cd761177fcd545)): ?>
<?php $component = $__componentOriginal1c54acf2bb0d54c9e6cd761177fcd545; ?>
<?php unset($__componentOriginal1c54acf2bb0d54c9e6cd761177fcd545); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\DeductionType','pageTitle' => 'Deduction Types Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2990439844-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/deduction-types.blade.php ENDPATH**/ ?>