...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Attendance Exemption"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginald767b2f2383f0946debadb54fc7c2d7e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald767b2f2383f0946debadb54fc7c2d7e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.attendance-exemption-tab-bar-links','data' => ['active' => 'check-in-only-employee']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.attendance-exemption-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'check-in-only-employee']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald767b2f2383f0946debadb54fc7c2d7e)): ?>
<?php $attributes = $__attributesOriginald767b2f2383f0946debadb54fc7c2d7e; ?>
<?php unset($__attributesOriginald767b2f2383f0946debadb54fc7c2d7e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginald767b2f2383f0946debadb54fc7c2d7e)): ?>
<?php $component = $__componentOriginald767b2f2383f0946debadb54fc7c2d7e; ?>
<?php unset($__componentOriginald767b2f2383f0946debadb54fc7c2d7e); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\CheckInOnlyEmployee','pageTitle' => 'Check-In-Only Employee Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1457591806-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/check-in-only-employee.blade.php ENDPATH**/ ?>