...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Allowances & Bonuses"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalb54c665059ef3907f850ecc80018b381 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb54c665059ef3907f850ecc80018b381 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.allowances-and-bonuses-tab-bar-links','data' => ['active' => 'employee-allowances']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.allowances-and-bonuses-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'employee-allowances']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb54c665059ef3907f850ecc80018b381)): ?>
<?php $attributes = $__attributesOriginalb54c665059ef3907f850ecc80018b381; ?>
<?php unset($__attributesOriginalb54c665059ef3907f850ecc80018b381); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb54c665059ef3907f850ecc80018b381)): ?>
<?php $component = $__componentOriginalb54c665059ef3907f850ecc80018b381; ?>
<?php unset($__componentOriginalb54c665059ef3907f850ecc80018b381); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\EmployeeAllowance','pageTitle' => 'Employee Allowances','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2339094102-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/employee-allowances.blade.php ENDPATH**/ ?>