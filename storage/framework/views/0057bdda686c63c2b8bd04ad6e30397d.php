...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Taxes & Deductions"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalb82a58edd3076b2623bc3d3c73d03ebb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb82a58edd3076b2623bc3d3c73d03ebb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.taxes-and-deductions-tab-bar-links','data' => ['active' => 'employee-deductions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.taxes-and-deductions-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'employee-deductions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb82a58edd3076b2623bc3d3c73d03ebb)): ?>
<?php $attributes = $__attributesOriginalb82a58edd3076b2623bc3d3c73d03ebb; ?>
<?php unset($__attributesOriginalb82a58edd3076b2623bc3d3c73d03ebb); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb82a58edd3076b2623bc3d3c73d03ebb)): ?>
<?php $component = $__componentOriginalb82a58edd3076b2623bc3d3c73d03ebb; ?>
<?php unset($__componentOriginalb82a58edd3076b2623bc3d3c73d03ebb); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\EmployeeDeduction','pageTitle' => 'Employee Deductions','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2274950996-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/employee-deductions.blade.php ENDPATH**/ ?>