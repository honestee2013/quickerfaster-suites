...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.payroll-processing-tab-bar-links','data' => ['active' => 'payrolls']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2076387270-0', $__slots ?? [], get_defined_vars());
