...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.allowances-and-bonuses-tab-bar-links','data' => ['active' => 'employee-bonuses']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'employee-bonuses']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\EmployeeBonus','pageTitle' => 'Employee Bonuses','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1161379386-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/employee-bonuses.blade.php ENDPATH**/ ?>