...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Attendance & Earning"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal2d3e27d60d1340e4664f3bcd781e7504 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2d3e27d60d1340e4664f3bcd781e7504 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.attendance-and-earning-tab-bar-links','data' => ['active' => 'daily-attendance']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.attendance-and-earning-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'daily-attendance']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2d3e27d60d1340e4664f3bcd781e7504)): ?>
<?php $attributes = $__attributesOriginal2d3e27d60d1340e4664f3bcd781e7504; ?>
<?php unset($__attributesOriginal2d3e27d60d1340e4664f3bcd781e7504); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal2d3e27d60d1340e4664f3bcd781e7504)): ?>
<?php $component = $__componentOriginal2d3e27d60d1340e4664f3bcd781e7504; ?>
<?php unset($__componentOriginal2d3e27d60d1340e4664f3bcd781e7504); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\DailyAttendance','pageTitle' => 'Daily Attendance Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-99944139-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/daily-attendance.blade.php ENDPATH**/ ?>