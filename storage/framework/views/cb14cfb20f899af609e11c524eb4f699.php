...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'core.views::components.layouts.navbars.sidebar-link-item','data' => ['iconClasses' => 'fa-employee-minus','url' => 'hr/employee-deductions','title' => 'Employee Deductions','anchorClasses' => ''.e(($active == 'employee-deductions')? 'active': '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['iconClasses' => 'fa-employee-minus','url' => 'hr/employee-deductions','title' => 'Employee Deductions','anchorClasses' => ''.e(($active == 'employee-deductions')? 'active': '').'']); ?>
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/components/layouts/navbars/auth/bonuses-and-deductions-tab-bar-links.blade.php ENDPATH**/ ?>