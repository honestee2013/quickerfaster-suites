                    ...
                    <!--[if BLOCK]><![endif]--><?php if($moreActions): ?>
                        ...
                        <span class="btn-group dropdown" data-bs-toggle="tooltip" data-bs-original-title="More" style="cursor: pointer">
                            ...
                            <ul class="dropdown-menu px-2 py-3" aria-labelledby="dropdownMenuButton">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $moreActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actionName => $actionData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!--[if BLOCK]><![endif]--><?php if(isset($actionData['title'])): ?>
                                        <pan class="m-2 text-uppercase text-xs fw-bolder"><?php echo e(ucfirst($actionData['title'])); ?></pan>
                                        <hr class="m-2 p-0 bg-gray-500" />
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                    <li>
                                        <!--[if BLOCK]><![endif]--><?php if(isset($actionData['route'])): ?>
                                            <a class="dropdown-item" href="javascript:void(0)" wire:click="openLink('<?php echo e($actionData['route']); ?>', <?php echo e($row->id); ?>)">
                                        <?php elseif(isset($actionData['updateModelField']) && isset($actionData['fieldName']) && isset($actionData['fieldValue'])): ?>
                                            <a class="dropdown-item" onclick="Livewire.dispatch('updateModelFieldEvent',['<?php echo e($row->id); ?>', '<?php echo e($actionData['fieldName']); ?>', '<?php echo e($actionData['fieldValue']); ?>'])">
                                        <?php else: ?>
                                            <a class="dropdown-item" href="javascript:void(0)">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if(isset($actionData['icon'])): ?>
                                                <i class="<?php echo e($actionData['icon']); ?>"></i>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <span class="btn-inner--text"><?php echo e(ucfirst($actionName)); ?></span>
                                        </a>
                                    </li>
                                    <!--[if BLOCK]><![endif]--><?php if(isset($actionData['hr'])): ?>
                                        <hr class="m-2 p-0 bg-gray-500" />
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package2/app/Modules/Core/Resources/views/data-tables/partials/table-body.blade.php ENDPATH**/ ?>