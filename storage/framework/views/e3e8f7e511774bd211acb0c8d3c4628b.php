...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "User Schedule Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalcc6bb40914694b22d43473e7b35e4ad4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcc6bb40914694b22d43473e7b35e4ad4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.user-schedule-management-tab-bar-links','data' => ['active' => 'user-schedules']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.user-schedule-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-schedules']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcc6bb40914694b22d43473e7b35e4ad4)): ?>
<?php $attributes = $__attributesOriginalcc6bb40914694b22d43473e7b35e4ad4; ?>
<?php unset($__attributesOriginalcc6bb40914694b22d43473e7b35e4ad4); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcc6bb40914694b22d43473e7b35e4ad4)): ?>
<?php $component = $__componentOriginalcc6bb40914694b22d43473e7b35e4ad4; ?>
<?php unset($__componentOriginalcc6bb40914694b22d43473e7b35e4ad4); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\UserSchedule','pageTitle' => 'User Schedules Overview','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1652417602-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/user-schedules.blade.php ENDPATH**/ ?>