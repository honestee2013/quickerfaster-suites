...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Role Schedule Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal21559c5b95d4e4e425749bbce01c8243 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal21559c5b95d4e4e425749bbce01c8243 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.role-schedule-management-tab-bar-links','data' => ['active' => 'role-work-days']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.role-schedule-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'role-work-days']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal21559c5b95d4e4e425749bbce01c8243)): ?>
<?php $attributes = $__attributesOriginal21559c5b95d4e4e425749bbce01c8243; ?>
<?php unset($__attributesOriginal21559c5b95d4e4e425749bbce01c8243); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal21559c5b95d4e4e425749bbce01c8243)): ?>
<?php $component = $__componentOriginal21559c5b95d4e4e425749bbce01c8243; ?>
<?php unset($__componentOriginal21559c5b95d4e4e425749bbce01c8243); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\RoleWorkDay','pageTitle' => 'Role Work Days','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-671012052-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/role-work-days.blade.php ENDPATH**/ ?>