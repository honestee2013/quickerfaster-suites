...
[$__name, $__params] = $__split('data-tables.data-table-form', ['pageTitle' => $pageTitle,'queryFilters' => $queryFilters,'configFileName' => $configFileName,'config' => $config,'readOnlyFields' => $readOnlyFields,'fieldGroups' => $fieldGroups,'fieldDefinitions' => $fieldDefinitions,'model' => $model,'moduleName' => $moduleName,'modelName' => $modelName,'recordName' => $recordName,'multiSelectFormFields' => $multiSelectFormFields,'singleSelectFormFields' => $singleSelectFormFields,'hiddenFields' => $hiddenFields,'columns' => $columns,'isEditMode' => $isEditMode,'modalId' => 'addEditModal']);
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2899835366-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2899835366-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Core/Resources/views/data-tables/data-table-manager.blade.php ENDPATH**/ ?>