                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="mb-2">
                                            <!--[if BLOCK]><![endif]--><?php if(isset($action['route'])): ?>
                                                <a class="dropdown-item border-radius-md" wire:click="openLink('<?php echo e($action['route']); ?>', <?php echo e($row->id); ?>)">
                                            <?php elseif(isset($action['updateModelField']) && isset($action['fieldName']) && isset($action['fieldValue'])): ?>
                                                <a class="dropdown-item border-radius-md" onclick="Livewire.dispatch('updateModelFieldEvent',['<?php echo e($row->id); ?>', '<?php echo e($action['fieldName']); ?>', '<?php echo e($action['fieldValue']); ?>'])">
                                            <?php else: ?>
...
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Core/Resources/views/data-tables/partials/table-body.blade.php ENDPATH**/ ?>