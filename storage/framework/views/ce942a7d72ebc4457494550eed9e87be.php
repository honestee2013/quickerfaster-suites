...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'core.views::components.layouts.navbars.sidebar-link-item','data' => ['iconClasses' => 'fas fa-money-bill-wave','url' => 'hr/payrolls','title' => 'Payrolls','anchorClasses' => ''.e(($active == 'payrolls')? 'active': '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['iconClasses' => 'fas fa-money-bill-wave','url' => 'hr/payrolls','title' => 'Payrolls','anchorClasses' => ''.e(($active == 'payrolls')? 'active': '').'']); ?>
