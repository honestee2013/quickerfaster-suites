...
<head>
    ...
    <title>Printable ID Card - <?php echo e($employee->user->name ?? 'N/A'); ?></title>
    <style>
...
<body>
    ...
    <div class="id-card-container">
        <div class="header">
            ...
            <!--<img src="<?php echo e(asset('assets/img/default_profile_picture.jpg')); ?>" alt="Company Logo" class="company-logo">-->
        ...
        <div class="photo-section">
            <?php
                $photoPath = $employee->user->basicInfo?->profile_picture
                    ? public_path('storage/' . $employee->user->basicInfo->profile_picture)
                    : public_path('assets/img/default_profile_picture.jpg');
            ?>

            <img src="<?php echo e($photoPath); ?>" alt="Employee Photo" class="employee-photo">
        </div>

        <div class="info-section">
            <div class="info-item">

                <span class="value" id="employee-name"><?php echo e($employee->user->name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="value" id="employee-id"><?php echo e($employee->employee_id ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">

                <span class="value" id="job-title"><?php echo e($employee->designation ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">

                <span class="value" id="department"><?php echo e($employee->department ?? 'N/A'); ?></span>
            </div>
        </div>

        <div class="qr-code-section">
            <div class="qr-code">
                <img src="<?php echo e($qrCodeImageSrc); ?>" alt="QR Code">
            </div>
        </div>
...
<?php /**PATH /Users/mac/LaravelProjects/suites.quickerfaster.com/app/Modules/Hr/Resources/views/id_card/show_printable.blade.php ENDPATH**/ ?>