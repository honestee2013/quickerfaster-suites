...
<?php endif; ?>
 <?php $__env->endSlot(); ?>
   ...
   <?php $__env->slot('pageHeader', null, []); ?> 
    <?php echo $__env->make('core.views::components.layouts.navbars.auth.content-header', [ "pageTitile" => "Onboarding Management"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginal9325d26709c1a080e9648f260f84eeed = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9325d26709c1a080e9648f260f84eeed = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'hr.views::components.layouts.navbars.auth.onboarding-management-tab-bar-links','data' => ['active' => 'user-onboarding-status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('hr.views::layouts.navbars.auth.onboarding-management-tab-bar-links'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'user-onboarding-status']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9325d26709c1a080e9648f260f84eeed)): ?>
<?php $attributes = $__attributesOriginal9325d26709c1a080e9648f260f84eeed; ?>
<?php unset($__attributesOriginal9325d26709c1a080e9648f260f84eeed); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9325d26709c1a080e9648f260f84eeed)): ?>
<?php $component = $__componentOriginal9325d26709c1a080e9648f260f84eeed; ?>
<?php unset($__componentOriginal9325d26709c1a080e9648f260f84eeed); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('data-tables.data-table-manager', ['model' => 'App\Modules\hr\Models\UserOnboardingStatus','pageTitle' => 'User Onboarding Status','queryFilters' => [
],'hiddenFields' => [
  'onTable' => 
  [
  ],
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2045204872-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/mac/LaravelProjects/testing-quicker-faster-crud-package/app/Modules/Hr/Resources/views/user-onboarding-statuses.blade.php ENDPATH**/ ?>